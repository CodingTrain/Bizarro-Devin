...
const animations = [
  ...
  { sprites: '360-A-Evil.png', frames: 8 },
  { sprites: 'Coffee.png', frames: 12 },
  { sprites: 'Coffee-Evil.png', frames: 12 },
  { sprites: 'Confused-A.png', frames: 8 },
  { sprites: 'Confused-B.png', frames: 8 },
  { sprites: 'Dancing.png', frames: 8 },
  { sprites: 'Dancing-Evil.png', frames: 8 },
  { sprites: 'Excited-A.png', frames: 12 },
  { sprites: 'Excited-B.png', frames: 8 },
  { sprites: 'Excited-B-Evil.png', frames: 8 },
  { sprites: 'Excited-C.png', frames: 8 },
  { sprites: 'Excited-C-Evil.png', frames: 8 },
  { sprites: 'Frazzled.png', frames: 8 },
  { sprites: 'Frazzled-Evil.png', frames: 8 },
  { sprites: 'Head-shaking.png', frames: 8 },
  { sprites: 'Head-shaking-Evil.png', frames: 8 },
  { sprites: 'Neutral-A.png', frames: 12 },
  { sprites: 'Neutral-A-Evil.png', frames: 12 },
  { sprites: 'Neutral-Waving.png', frames: 16 },
  { sprites: 'Neutral-Waving-Evil.png', frames: 16 },
  { sprites: 'Noding.png', frames: 8 },
  { sprites: 'Noding-Evil.png', frames: 8 },
  { sprites: 'Ooooh.png', frames: 8 },
  { sprites: 'Ooooh-Evil.png', frames: 8 },
  { sprites: 'Talking.png', frames: 6 },
];

const stateAnimations = {
  pending: ['Neutral-Waving-Evil'],
  talking: ['Talking'],
  typing: ['Nodig-Evil', 'Excited-B-Evil'],
  thinking: ['360-A-Evil', 'Coffee-Evil'],
};
